...
/// @nodoc
mixin _$BaseResult<T> {
  @optionalTypeArgs
  TResult when<TResult extends Object?>({
    required TResult Function(T data) success,
    required TResult Function(AnyException exception) failure,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? whenOrNull<TResult extends Object?>({
    TResult? Function(T data)? success,
    TResult? Function(AnyException exception)? failure,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
class _$SuccessImpl<T> implements Success<T> {
  ...
  @override
  String toString() {
    return 'BaseResult<$T>.success(data: $data)';
  }
...
abstract class Success<T> implements BaseResult<T> {
...
class _$FailureImpl<T> implements Failure<T> {
  ...
  @override
  String toString() {
    return 'BaseResult<$T>.failure(exception: $exception)';
  }
...
abstract class Failure<T> implements BaseResult<T> {
  const factory Failure(final AnyException exception) = _$FailureImpl<T>;
